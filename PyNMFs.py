...
class PyNMFs():
    def NMF(self, opts, Yr_Mlist, Yc_Mlist, Dh5Path, Xh5Path, workdir):
        self.opts = opts
        self.prcountRow = len(Yr_Mlist)
        self.prcountCol = len(Yc_Mlist)
        ...
        self.Yr_Mlist = Yr_Mlist
        self.Yc_Mlist = Yc_Mlist
